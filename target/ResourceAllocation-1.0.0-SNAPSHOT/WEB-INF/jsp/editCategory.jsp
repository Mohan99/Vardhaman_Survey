...
<div id="page-wrapper">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="col-md-6">
             <form:form class="form-horizontal"  modelAttribute="categoryRequest" method="GET" action="${pageContext.request.contextPath}/Category/createOrupdateCategory">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-7">
    <form:input class="form-control disabled" id="categoryName" name="categoryName" value="${category.getCategoryName()}" path="categoryName" />
