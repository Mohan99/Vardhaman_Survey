			...
			<ul class="nav navbar-right navbar-top-links">
				<c:choose>
					...
					<c:otherwise>
						<li class="dropdown"><a class="dropdown-toggle"
							data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i>
								${sessionScope['scopedTarget.sessionObj'].getEmpUsersObj().getEmpId().getEmployeeName()}
								<b class="caret"></b>
						</a>
							<ul class="dropdown-menu dropdown-user">
								<li><a
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu" style="margin-top: 16px;">
							...
							<ul class="nav nav-second-level">
								<li><a
									href="<%=request.getContextPath()%>/Users/searchUsers"><i
										class="glyphicon glyphicon-search"></i> Search User </a></li>
								<li><a
								...
								<li><a
									href="<%=request.getContextPath()%>/Users/employeeLoginUsers"><i
										class="glyphicon glyphicon-search"></i> Employee Logging Users
								</a></li>
								<li><a
									href="<%=request.getContextPath()%>/Users/createEmployeeLoging"><i
										class="fa fa-user-plus fa-fw"></i> Create Employee Login </a></li>
						...
						<li><a href="#"><i class="fa fa-list fa-fw"></i> Holiday
								Master <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level">
								<li><a
						...
						<li><a href="#"><i class="fa fa-list fa-fw"></i> Projects
						...
						<c:choose>
							<c:when
								test="${not empty sessionScope['scopedTarget.sessionObj'].getEmpUsersObj().getEmpId().getEmployeeName()}">
							...
							<ul class="nav nav-second-level">
								...
								<li><a
									href="<%=request.getContextPath()%>/Reports/empsTotalBenchPeriod"><i
										class="glyphicon glyphicon-equalizer"></i> Total Bench Period
										Report </a></li>
								<%-- <li><a
								...
								<li><a
									href="<%=request.getContextPath()%>/Reports/allEmpsTotalBenchPeriod"><i
										class="glyphicon glyphicon-equalizer"></i>Employee wise Bench
										Report</a></li>
								<li><a
									href="<%=request.getContextPath()%>/Reports/timesheetReport"><i
