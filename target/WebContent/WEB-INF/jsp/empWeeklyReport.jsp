			...
			<div class="col-lg-12">
				...
				<div class="col-md-6">
					<form:form class="form-horizontal"
						...
						action="${pageContext.request.contextPath}/Reports/getWeekReport">


						<div class="form-group">
							<label for=" " class="col-sm-5 control-label">StartDate</label>
							<div class="col-sm-7">
								<form:input id="startDate"  class="form-control datepicker disabled" onchange="StartDateAllowMonday(this.id)" value="${EmpReportDataRequest.getStartDate()}" path="startDate" />
							</div>
						</div>
						<div class="form-group">
							<label for=" " class="col-sm-5 control-label">EndDate</label>
							<div class="col-sm-7">
								<form:input id="endDate" class="form-control datepicker disabled" onchange="StartDateAllowSunDay(this.id)" value="${EmpReportDataRequest.getEndDate()}" path="endDate" />
							</div>
						</div>
                        ...
                        <tr class="gradeA odd" role="row">
                         <td class="sorting_1">${reportObj.employeeName}</td>                   
                          <td>${reportObj.empID}</td>
                           <td>${reportObj.monHours}</td>
                                                
                          <td>${reportObj.tueHours}</td>
                           <td>${reportObj.wedHours}</td>
                                                
                          <td>${reportObj.thuHours}</td>
                           <td>${reportObj.friHours}</td>
                                                
                          <td>${reportObj.satHours}</td>
                           <td>${reportObj.sunHours}</td>
