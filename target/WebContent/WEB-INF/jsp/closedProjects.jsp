...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Closed Project</h3>
										...
										<tbody>
											...
											<c:forEach var="project" items="${projectList}">
												...
												<tr class="gradeA odd" role="row">
													...
													<%-- <td>
													<c:choose>
														<c:when test="${project.status=='true'}">Completed <br /></c:when>
														<c:otherwise>Not Completed<br /></c:otherwise>
													</c:choose></td> --%>
