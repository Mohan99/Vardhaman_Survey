			...
			<div class="col-lg-12">
				...
				<div class="col-md-6">
					<form:form class="form-horizontal"
						...
						action="${pageContext.request.contextPath}/Reports/getDetailedReport">
					...
					<div class="panel-body">
									...
									<table width="100%"
										...
										<thead>
											...
											<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1">Date</th>
												<th class="sorting" tabindex="0"
					  ...
					  <c:forEach var="reportObj" items="${EmployeeResponseReport}">
                        ...
                        <tr class="gradeA odd" role="row">
                         <td>${reportObj.date}</td>
                         <td class="sorting_1">${reportObj.employeeName}</td>                   
                          <td>${reportObj.empID}</td>
                           <td>${reportObj.inTime}</td>
                           <td>${reportObj.outTime}</td>                                              
                          <td>${reportObj.lateInTime}</td>
                           <td>${reportObj.earlyLogOut}</td>                                              
                          <td>${reportObj.totalTime}</td>
                           <td>${reportObj.noOfInHours}</td>                                             
                          <td>${reportObj.noOfOutHours}</td>
                             </tr>
                  </c:forEach>  
