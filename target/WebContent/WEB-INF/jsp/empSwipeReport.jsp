...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header">Swipe Report</h3>
				<div class="col-md-6">
					<form:form class="form-horizontal"
						modelAttribute="EmpReportDataRequest" id="form" method="post"
						action="${pageContext.request.contextPath}/Reports/getSwipeReport">
                        ...
                        <tr class="gradeA odd" role="row">
                         ...
                         <td class="sorting_1">${reportObj.employeeName}</td>                   
                          <td>${reportObj.empID}</td>
                           <td>${reportObj.shiftStartTime}</td>
                           <td>${reportObj.shiftEndTime}</td>                                                                  
                           <td>${reportObj.swipeTime}</td>                                              
                          <td>${reportObj.swipeInOut}</td>                     
                             </tr>
                  </c:forEach>  
