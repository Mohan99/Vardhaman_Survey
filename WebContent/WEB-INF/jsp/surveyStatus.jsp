										...
										<thead>
											<tr role="row" class="bg-warning">
												...
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Browser: activate to sort column ascending"
													style="width: 207px;">Survey Status</th>
										...
										<tbody>
											...
											<c:forEach var="campaign" items="${campaignList}">
												...
												<tr class="gradeA odd" role="row">
													...
													<td class="center"><a
														href="<%=request.getContextPath()%>/Campaign/getSurveyStatus/${campaign.id}/${campaign.vendorType.id}">
															<i class="btn btn-success btn-sm">Show Survey Status </i>
													</a></td>
												</tr>
											</c:forEach>
										</tbody>
