...
<div id="page-wrapper">
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header"> Create Vendor </h3>
				<div class="col-md-6">
					<form:form class="form-horizontal" modelAttribute="vendorRequest"
						method="GET"
						action="${pageContext.request.contextPath}/Vendor/createOrupdateVendor">

						<div class="form-group">
							<label for=" " class="col-sm-5 control-label"> Vendor Name</label>
							<div class="col-sm-7">
